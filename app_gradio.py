...
SAMPLE_DATA = {
    ...
    "European Union": CountryTariffData(
        ...
        trade_volume=400.0,
        sector_impacts={
            "technology": 0.70, "agriculture": 0.25, "textiles": 0.50,
            "chemicals": 0.65, "machinery": 0.75, "automotive": 0.80,
            "metals": 0.60, "energy": 0.40, "pharmaceuticals": 0.55,
            "food_processing": 0.30, "electronics": 0.65, "furniture": 0.45
        }
    ),
    "Japan": CountryTariffData(
        ...
        sector_impacts={
            ...
            "chemicals": 0.60, "machinery": 0.85, "automotive": 0.90,
            "metals": 0.70, "energy": 0.30, "pharmaceuticals": 0.45,
    ...
    "India": CountryTariffData(
        ...
        trade_volume=150.0,
        sector_impacts={
            "technology": 0.75, "agriculture": 0.40, "textiles": 0.80,
            "chemicals": 0.60, "machinery": 0.55, "automotive": 0.50,
            "metals": 0.45, "energy": 0.35, "pharmaceuticals": 0.85,
            "food_processing": 0.35, "electronics": 0.70, "furniture": 0.60
        }
    ),
    ...
    "Vietnam": CountryTariffData(
        ...
        trade_volume=100.0,
        sector_impacts={
            "technology": 0.50, "agriculture": 0.55, "textiles": 0.85,
            "chemicals": 0.45, "machinery": 0.40, "automotive": 0.35,
            "metals": 0.35, "energy": 0.25, "pharmaceuticals": 0.30,
            "food_processing": 0.60, "electronics": 0.70, "furniture": 0.80
        }
    ),
...
SECTORS = [
    ...
    "automotive", "metals", "energy", "pharmaceuticals", 
    "food_processing", "electronics", "furniture"
]
...
def calculate_country_analysis(countries: List[str], sectors: List[str]) -> Dict:
    ...
    for country in countries:
        ...
        country_result = {
            ...
            "sector_impacts": {k: v for k, v in data.sector_impacts.items() if k in sectors}
        }
    ...
    if analysis["country_impacts"]:
        analysis["summary"]["avg_disruption"] = total_disruption / len(analysis["country_impacts"])
...
def get_preset_selection(preset: str) -> Tuple[List[str], List[str]]:
    ...
    if preset == "Major Economies":
        return (["China", "European Union", "Japan", "India"], 
                ["technology", "automotive", "machinery"])
    elif preset == "Asian Markets":
        return (["China", "Japan", "South Korea", "Taiwan", "Vietnam"], 
                ["technology", "textiles", "electronics"])
    elif preset == "ASEAN Countries":
        return (["Vietnam", "Thailand", "Singapore", "Malaysia"], 
                ["agriculture", "textiles", "chemicals"])
    else:  # Custom Selection
        return (["China", "European Union", "Japan", "Vietnam"], 
...
def run_analysis(preset, custom_countries, custom_sectors):
    ...
    try:
        ...
        if not analysis_results["country_impacts"]:
            return "❌ No valid data found for selected countries and sectors.", None, ""
        ...
        **Analyze the economic impact of tariffs across countries and sectors**
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                preset = gr.Dropdown(
                    choices=["Major Economies", "Asian Markets", "ASEAN Countries", "Custom Selection"],
        ...
        with gr.Row():
            results_table = gr.Dataframe(
                ...
                headers=["Country", "Economic Disruption (%)", "GDP Impact (USD B)", "Trade Volume (USD B)", "Risk Level"],
                interactive=False
            )
