...
# Data structures and sample data (based on real Trump tariff data)
@dataclass
...
def calculate_country_analysis(
    ...
    for country in countries:
        ...
        avg_disruption = float(np.mean(sector_disruptions))
...
def run_analysis(
    preset: str,
    custom_countries: List[str],
    custom_sectors: List[str],
    custom_tariff_rate: Optional[float] = None,
    ...
    try:
        ...
        # Run analysis
        analysis_results = calculate_country_analysis(
            countries, sectors, custom_tariff_rate
        )
        ...
        return f"❌ Unexpected error: {str(e)}", None, "", pd.DataFrame()
...
def create_gradio_app():
    ...
    with gr.Blocks(
        ...
        .gr-markdown h4, .gr-markdown strong, .gr-markdown li, .gr-markdown div {
        ...
        .gr-dropdown label, .gr-checkboxgroup label, .gr-slider label {
            color: #f1f5f9 !important;
            font-weight: 600 !important;
        }
        ...
        * {
        ...
        /* Light background elements get dark text */
        ...
        **Analyze the economic impact of tariffs across countries and sectors**
        ...
        analyze_btn.click(
            fn=run_analysis,
            inputs=[preset, custom_countries, custom_sectors, custom_tariff_rate],
