...
class TIPMModel:
    ...
    def predict(self, tariff_shock: TariffShock) -> TIPMPrediction:
        ...
        self.logger.info(f"Predicting impact for tariff shock: {tariff_shock.tariff_id}")
        ...
        confidence_scores = self._calculate_confidence_scores(
            policy_features, trade_impact, industry_impact,
            firm_impact, consumer_impact, geopolitical_impact
        )
    ...
    def simulate_scenario(self, 
        ...
        """
        self.logger.info(f"Running scenario simulation with {len(tariff_shocks)} shocks")
