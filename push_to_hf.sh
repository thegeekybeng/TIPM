...
echo "🚀 Pushing TIPM v3.0 to existing Hugging Face Space..."

# Create a temporary directory for the space
SPACE_DIR="tipm-hf-temp"
rm -rf "$SPACE_DIR"
mkdir -p "$SPACE_DIR"
cd "$SPACE_DIR"

echo "📋 Creating Gradio app for Hugging Face..."
...
echo "📤 Pushing to existing Hugging Face Space..."
git remote add origin https://huggingface.co/spaces/thegeekybeng/tipm-v3-demo
git branch -M main
git push -u origin main --force

echo "✅ Push complete!"
echo "🌐 Your TIPM v3.0 space is available at: https://huggingface.co/spaces/thegeekybeng/tipm-v3-demo"
